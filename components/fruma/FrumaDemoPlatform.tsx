...
type ActiveMill = (typeof mills)[number];
...
export function FrumaDemoPlatform() {
  ...
  if (stage === "workspace") {
    return <FactoryWorkspace view={factoryView} setView={setFactoryView} activeMill={activeMill} onBrand={() => setStage("brand")} onSetup={() => setStage("map")} />;
  }
...
function FactoryWorkspace({ view, setView, activeMill, onBrand, onSetup }: { view: FactoryView; setView: (v: FactoryView) => void; activeMill: ActiveMill; onBrand: () => void; onSetup: () => void }) {
  return <div className="cd-shell mill">
...
function FactoryRequests({ activeMill }: { activeMill: ActiveMill }) {
...
function FactoryBook({ activeMill }: { activeMill: ActiveMill }) {
...
function FactoryEvidence({ activeMill }: { activeMill: ActiveMill }) {
